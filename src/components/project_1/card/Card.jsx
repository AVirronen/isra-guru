		...
		<div className={styles.card__container}>
			...
			<div className={styles.content}>
				...
				<div className={styles.question__container}>
					...
					<p className={styles.question__container_description} id={"smallDescription"}>{`${content.smallDescription}`}</p>
				...
				<div className={styles.day__container}>
					<div className={styles.info__container}>
						...
						<p className={styles.info__container_description}>
							<span id={"data/month"}></span>{content.month}<span id={"data/weekDay"}>{content.weekDay}</span>
						</p>
					</div>
				...
				<ul className={styles.price__container}>
					...
					<li className={styles.price__container_item}>
						...
						<p className={styles.price__container_description}><span id={"timeFrom"}>{content.timeTo}</span> - <span
