...
const PicAdd = (props) => {
    ...
    //     for (let i = 0; i < files.length; i++) {
    //         const file = files[i];
    //         const imageRef = ref(storage, `images/${props.id}/image_1_${counter}`);
    //         // const imageRef = ref(storage, `images/1/image_2_${counter}`);
    //         // const index = selectedFiles.length + i + 1;
    //         // const imageRef = ref(storage, `images/${props.id}/image_2_${index}`);
    //
    //         await uploadBytes(imageRef, file);
    //     }
    // }
    ...
    //     setCounter(1)
    //
    //     const imageRef = ref(storage, `images/${props.id}/image_1_main`);
    //     // const imageRef = ref(storage, `images/1/image_2_main`);
    //
    //     await uploadBytes(imageRef, file);
    // }
    //
